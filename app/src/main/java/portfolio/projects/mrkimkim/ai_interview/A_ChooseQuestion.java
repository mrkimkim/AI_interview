...
public class A_ChooseQuestion extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                // 샘플 가이드 영상을 클릭한 경우
                    ...
                    Intent intent = YouTubeStandalonePlayer.createVideoIntent(A_ChooseQuestion.this, YOUTUBE_API_KEY, VIDEO_ID);
                    startActivity(intent);
                }

                else if (v.getId() == R.id.question_card) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(A_ChooseQuestion.this);
